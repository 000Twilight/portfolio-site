...
interface CoverImageProps {
  ...
  colorIndex: number;
  /**
   * Set to true for images that are above the fold (LCP candidates).
   * Maps to Next.js Image `priority` which adds loading="eager" + fetchpriority="high".
   */
  priority?: boolean;
  className?: string;
}
...
export function CoverImage({ images, alt, colorIndex: _colorIndex, priority = false, className }: CoverImageProps) {
