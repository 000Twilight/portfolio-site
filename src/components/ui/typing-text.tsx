    ...
    return (
        <div className="relative mx-auto w-full max-w-4xl py-24">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center text-center">
                <div
                    className={cn(
                        "flex items-center gap-1 font-mono text-4xl text-black tracking-tight md:text-6xl dark:text-white transition-opacity duration-500",
                ...
                >
                    ...
                    <span
                        className="inline-block h-[1em] w-[3px] bg-black dark:bg-white animate-blink"
                    />
                </div>
            </div>
        </div>
