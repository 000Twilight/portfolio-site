            ...
            >
                ...
                <ParallaxLayer speedX={0.015} speedY={0.015} movement={0.15} center zIndex={1}>
                    ...
                    <div
                        ...
                        style={{
                            background: "radial-gradient(circle, rgba(229,231,235,0.18) 0%, rgba(156,163,175,0.06) 40%, transparent 70%)",
                        }}
                    />
                    <div
                        ref={ambientGlowRef}
                        className="scene-deep-bg absolute left-[28%] top-[20%] h-[720px] w-[720px] rounded-full bg-gradient-to-tr from-slate-900/60 via-slate-800/40 to-slate-700/20 blur-[160px]"
                    />
                </ParallaxLayer>
                ...
                {/* ============================================================
                    LAYER 4: Distant Laser Filaments
                ============================================================= */}
                <ParallaxLayer speedX={0.045} speedY={0.05} movement={0.45} center zIndex={4} className="left-1/2 top-[35%]">
                    <div
                        ...
                        style={{
                            ...
                            background:
                                "linear-gradient(90deg, transparent 0%, rgba(229,231,235,0.6) 45%, rgba(156,163,175,0.7) 55%, transparent 100%)",
                        }}
                    />
                </ParallaxLayer>
                    ...
                    >
                        <div>
                            ...
                            <div className="flex items-center gap-2 mt-1">
                                <span className="h-1.5 w-1.5 rounded-full bg-slate-200 animate-pulse shadow-[0_0_8px_#e5e7eb]" />
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-3 mt-1.5">
                                <span className="text-xs text-slate-200 font-bold">Z: +420</span>
                                <div className="flex items-end gap-[3px] h-3.5">
                                    <div className="w-[3px] h-2 bg-slate-300/60 rounded-full" />
                                    <div className="w-[3px] h-3 bg-slate-300/80 rounded-full" />
                                    <div className="w-[3px] h-3.5 bg-slate-200 rounded-full" />
                                    <div className="w-[3px] h-2.5 bg-slate-300/90 rounded-full" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <ParallaxLayer speedX={0.09} speedY={0.095} movement={0.82} center zIndex={10} className="left-[92%] top-[48%]">
                    <div className="scene-midground-glass hidden xl:flex flex-col items-center gap-3">
                        <div className="relative h-28 w-28 rounded-full border border-white/15 flex items-center justify-center">
                            ...
                            <div className="h-1.5 w-1.5 rounded-full bg-slate-200 shadow-[0_0_10px_#e5e7eb]" />
                    ...
                    >
                        <div className="absolute inset-2 border border-dashed border-white/15 rounded-xl flex flex-col justify-between p-3">
                            ...
                            <div className="flex justify-between items-center text-[9px] font-mono text-zinc-500">
                                <span>3D FACET</span>
                                <span className="text-slate-300">CHAMFER</span>
                            </div>
                        </div>
                    </div>
                </ParallaxLayer>
                ...
                <ParallaxLayer speedX={0.12} speedY={0.13} movement={1.05} center zIndex={15} className="left-[16%] top-[42%]">
                    <div
                        ...
                        className="scene-midground-glass h-16 w-16 rounded-full border border-white/40 shadow-[0_0_30px_rgba(229,231,235,0.2),inset_0_2px_4px_rgba(255,255,255,0.8),inset_0_-6px_12px_rgba(0,0,0,0.9)]"
                        style={{
                            background:
                ...
                <ParallaxLayer speedX={0.13} speedY={0.14} movement={1.12} center zIndex={16} className="left-[84%] top-[34%]">
                    <div
                        ...
                        className="scene-midground-glass h-20 w-20 rounded-full border border-white/40 shadow-[0_0_35px_rgba(229,231,235,0.25),inset_0_2px_4px_rgba(255,255,255,0.8),inset_0_-6px_14px_rgba(0,0,0,0.9)]"
                        style={{
                            background:
                    ...
                    <div ref={coreRef} className="scene-core-monolith pointer-events-auto flex flex-col items-center">
                        ...
                        <div className="mb-4 flex items-center gap-2.5 rounded-full border border-white/15 border-t-white/35 bg-white/[0.04] px-4 py-1.5 shadow-[inset_0_1px_1px_rgba(255,255,255,0.2)] backdrop-blur-xl">
                            <span className="relative flex h-2 w-2">
                                ...
                                <span className="relative inline-flex h-2 w-2 rounded-full bg-slate-200 shadow-[0_0_8px_#e5e7eb]" />
                            </span>
                        ...
                        <div className="relative my-2 flex items-center justify-center h-64 w-64" style={{ transformStyle: "preserve-3d" }}>
                            ...
                            <div
                                className="absolute h-52 w-52 rounded-full border border-dashed border-slate-300/40"
