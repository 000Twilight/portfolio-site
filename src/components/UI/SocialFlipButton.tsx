        ...
        >
            ...
            >
                ...
                <div
                    ref={nodeRef}
                    className={cn(
                        "absolute inset-0 flex items-center justify-center rounded-xl bg-[#F3F4F6] border border-[#E5E7EB] text-base font-bold text-[#1F2937] shadow-xs transition-colors",
                        frontClassName
                    )}
                ...
                <div
                    className={cn(
                        "absolute inset-0 flex items-center justify-center rounded-xl bg-[#1F2937] text-base text-[#F9FAFB] shadow-xs",
                        backClassName
                    )}
                    style={{
